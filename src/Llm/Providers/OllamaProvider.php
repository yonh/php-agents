...
/**
 * Stub provider for Ollama. Currently throws for all methods.
 */
class OllamaProvider implements LlmProviderInterface
{
    ...
    {
        throw new ConfigException('Ollama provider not implemented yet');
    }

    public function stream(array $request, callable $callback): void
    {
        throw new ConfigException('Ollama provider stream not implemented yet');
    }
